      ...
      <div className="relative z-10 w-full max-w-md">
        ...
        <div className="glass-panel rounded-3xl p-6 space-y-5">
          ...
          <button
            type="button"
            onClick={start}
            className="btn-sheen w-full py-4 rounded-2xl bg-gradient-to-r from-amber-400 via-amber-500 to-amber-600 text-night-900 font-black text-lg tracking-wide hover:scale-[1.02] active:scale-95 transition-all shadow-gold-glow"
          >
